  ...
  return (
    <nav
      style={{
        ...
        background: "#fffaf3", // creamy tone like screenshot
        border: "1px solid #e4e0d7",
        borderRadius: "12px", // squared but a little rounded
        padding: "12px 30px",
        display: "flex",
        alignItems: "center",
        gap: "28px",
    ...
    >
      ...
      <Link
        ...
        style={{
          ...navLinkStyle,
          background: "#7c3aed", // purple like your screenshot button
          color: "white",
          padding: "8px 18px",
          borderRadius: "8px",
        }}
...
const dropdownStyle: React.CSSProperties = {
  ...
  top: "40px",
  left: 0,
  background: "#fffaf3", // same creamy navbar tone
  border: "1px solid #e4e0d7",
  borderRadius: "12px",
  padding: "15px 20px",
